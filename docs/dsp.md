...
`Audio#lufs` and `normalize(mode: :lufs)` use BS.1770 K-weighting, 400 ms blocks, an absolute −70 LUFS gate, and a relative −10 LU gate. Triangle oscillators use an additive band-limited wavetable; square and sawtooth use polyBLEP correction.
